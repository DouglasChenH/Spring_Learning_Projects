...
/*
this repository is an interface and will allow you to perform various operations involving Person objects.
...
Then it will use the @RepositoryRestResource annotation
